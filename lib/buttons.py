...
login_items = ['мои загрузки', 'загрузить фото', 'сменить пароль','сменить время чистки','завершить сессию']
menu_items = ['регистрация','войти','помощь']
yes_no_items = {'one_time_keyboard': True,
    'keyboard': [ ['да'],['нет']]}
kick_out = {
    'resize_keyboard':True,
    'keyboard': [ ['назад']]
}
under_upload_menu = build_keyboard(['новый список','веcь список','удалить просмотренные','назад'])
